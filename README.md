...
The package can be installed from npm `react-draft-js-wysiwyg`

```
$ npm install --save react-draft-js-wysiwyg draft-js
```
...
```js
import { Editor } from "react-draft-js-wysiwyg";
import "react-draft-js-wysiwyg/dist/react-draft-js-wysiwyg.css";
<Editor
